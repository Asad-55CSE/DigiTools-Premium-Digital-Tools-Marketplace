            ...
            <div className="flex items-center gap-3 mt-6">
              {[
                ...
                <a
                  ...
                  href="#"
                  aria-label={label}
                  className="w-9 h-9 rounded-full bg-gray-800 hover:bg-purple-600 flex items-center justify-center text-gray-400 hover:text-white transition-all duration-200"
                >
                  {icon}
                </a>
              ))}
